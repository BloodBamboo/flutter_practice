...
import 'package:flutter_app/page/tweet_detail_page.dart';

class TweetListItem extends StatelessWidget {
  final Map<String, dynamic> _tweetData;
  final RegExp regExp1 = new RegExp("</.*>");
  final RegExp regExp2 = new RegExp("<.*>");

  TweetListItem({key, @required tweetData})
        ...
        Row(
          ...
          children: <Widget>[
            Container(
              ...
              child: CircleAvatar(
                backgroundImage:
                    NetworkImage(_tweetData['portrait'], scale: 1.5),
              ),
            ),
            Column(
...
//                  fontWeight: FontWeight.bold,
        ...
        Padding(
          ...
          child: Text(
            '${clearHtmlContent(_tweetData['body'])}',
            style: TextStyle(fontSize: 18.0),
          ),
        ),
      ];

      String _imgSmall = _tweetData['imgSmall'];
      ...
      return InkWell(
          onTap: () => Navigator.of(context).push(MaterialPageRoute(
              builder: (context) => TweetDetailPage(id: _tweetData['id']))),
          child: Padding(
        ...
        children: <Widget>[
          ...
          Row(
            children: <Widget>[
              ...
              Text(
                _tweetData['commentCount'] == 0
                    ? '评论'
                    : '${_tweetData['commentCount']}',
                style: TextStyle(color: Color(0xffaaaaaa), fontSize: 12.0),
              ),
            ],
          ),
